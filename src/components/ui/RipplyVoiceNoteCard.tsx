...
export const RipplyVoiceNoteCard = React.memo(function RipplyVoiceNoteCard({
	...
	return (
		...
		>
			...
			>
				<div className="relative w-full h-full flex flex-col justify-between text-white font-sans p-4">
					<div className="relative flex-grow flex flex-col justify-between">
						...
						<div>
							...
							<div className="flex items-center justify-around w-full text-xs text-white/80 drop-shadow-lg">
